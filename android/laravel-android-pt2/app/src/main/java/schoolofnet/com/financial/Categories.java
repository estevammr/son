...
public class Categories extends Fragment implements View.OnClickListener {
    ...
    public void findCategories() throws IOException, JSONException {
        HttpGet clientGet = new HttpGet("http://635a0e19.ngrok.io/api/categories");
    ...
    public void deleteCategory() {
        ...
        HttpDelete clientDelete = new HttpDelete("http://635a0e19.ngrok.io/api/categories/" + id.toString());
