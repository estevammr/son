    ...
    <div class="row" id="main">
      <div class="col s12 m4 l3 blue-grey padding-top" id="left-side">
        <div class="valign-wrapper">
          <div class="col" layout="row">
            <img src="http://www.reporting-studio.net/images/biz-user-icon.png" alt="Estevam Rodrigues" class="circle">
          </div>
          <div>
            <p>
              <span class="grey-text text-lighten-2">Estevam Rodrigues</span><br>
      ...
      <div class="col s12 m8 l9 grey lighten-3" id="right-side">
        ...
        <div class="col s10 grey lighten-2">
          <small>by <a href="">Estevam Rodrigues</a> -  &copy; 2017</small>
        </div>
